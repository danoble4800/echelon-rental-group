...
CARS = [
    ...
    },
    {
        ...
        "badge": "available",
        "price": "650",
        "image": "images/fleet/corvette-c8-1.webp",
        "image_pos": "60%",
        "gallery": [f"images/fleet/corvette-c8-{i}.webp" for i in range(1, 5)],
        "deposit": "$2,500",
        "hp": "495 hp",
        "torque": "470 lb-ft",
        "zero_sixty": "2.9s",
    ...
    },
    {
        ...
        "badge": "available",
        "price": "1,000",
        "image": "images/fleet/bentayga-1.webp",
        "image_pos": "60%",
        "gallery": [f"images/fleet/bentayga-{i}.webp" for i in range(1, 6)],
        "deposit": "$3,000",
        "hp": "542 hp",
        "torque": "568 lb-ft",
        "zero_sixty": "4.4s",
    ...
    },
    {
        ...
        "badge": "available",
        "price": "600",
        "image": "images/fleet/escalade-esv-1.webp",
        "image_pos": "60%",
        "gallery": [f"images/fleet/escalade-esv-{i}.webp" for i in range(1, 6)],
        "deposit": "$2,500",
        "hp": "420 hp",
        "torque": "460 lb-ft",
        "zero_sixty": "6.0s",
  ...
  <footer class="footer">
    <div class="footer-inner footer-inner--wide">
      ...
      <div class="footer-links">
        <h4>Quick Links</h4>
        <a href="exotics.html">Home</a>
        <a href="fleet.html">View Full Fleet</a>
        <a href="reserve.html">Reserve a Car</a>
        <a href="how-it-works.html">How It Works</a>
      ...
      <div class="footer-links">
        <h4>Resources</h4>
        <a href="rental-policies.html">Rental Policies</a>
        <a href="cancellation-policy.html">Cancellation &amp; Refunds</a>
    ...
    <div class="section-inner">
      ...
      <div class="vehicle-hero-grid">
        ...
        <div class="vehicle-hero-info">
          ...
          <p class="vehicle-policy-note">Deposit, insurance, and mileage details are covered in our <a href="rental-policies.html" class="inline-link">Rental Policies</a>. Delivering outside the 10-mile radius? See our <a href="service-areas.html" class="inline-link">Service Areas</a>.</p>
        </div>
      </div>
    </div>
  </section>
...
{vehicle_options}
          ...
          <div class="form-group checkbox-group">
            <label class="checkbox-label" style="color:var(--dark-text-2);">
              ...
              I confirm I have a valid driver's license and agree to the <a href="rental-policies.html" target="_blank" class="inline-link">Rental Policies</a>, <a href="cancellation-policy.html" target="_blank" class="inline-link">Cancellation Policy</a>, and <a href="terms-of-service.html" target="_blank" class="inline-link">Terms of Service</a>.
            </label>
          </div>
