...
const exoticsI18n = {
  en: {
    ...
    types: ['Supercar', 'Supercar', 'Ultra-Luxury Sedan', 'Sports Car'],
    specs: ['630 hp · 0–60 in 2.9s · 2 Seats', '661 hp · 0–60 in 3.0s · 2 Seats', '563 hp · 5 Seats · Chauffeur Available', '640 hp · 0–60 in 2.6s · 4 Seats'],
    pills: [['AWD', 'V10', 'Delivery'], ['Twin-Turbo V8', 'Delivery'], ['Chauffeur Option', 'Delivery'], ['AWD', 'Delivery']],
  ...
  es: {
    ...
    types: ['Superdeportivo', 'Superdeportivo', 'Sedán Ultra de Lujo', 'Auto Deportivo'],
    specs: ['630 hp · 0–100 en 2.9s · 2 Asientos', '661 hp · 0–100 en 3.0s · 2 Asientos', '563 hp · 5 Asientos · Chofer Disponible', '640 hp · 0–100 en 2.6s · 4 Asientos'],
    pills: [['Tracción AWD', 'V10', 'Entrega'], ['V8 Biturbo', 'Entrega'], ['Opción de Chofer', 'Entrega'], ['Tracción AWD', 'Entrega']],
  ...
  pt: {
    ...
    types: ['Superesportivo', 'Superesportivo', 'Sedã Ultra de Luxo', 'Carro Esportivo'],
    specs: ['630 cv · 0–100 em 2.9s · 2 Lugares', '661 cv · 0–100 em 3.0s · 2 Lugares', '563 cv · 5 Lugares · Motorista Disponível', '640 cv · 0–100 em 2.6s · 4 Lugares'],
    pills: [['Tração AWD', 'V10', 'Entrega'], ['V8 Biturbo', 'Entrega'], ['Opção de Motorista', 'Entrega'], ['Tração AWD', 'Entrega']],
