...
const exoticsI18n = {
  en: {
    ...
    types: ['Supercar', 'Ultra-Luxury SUV', 'Ultra-Luxury Sedan', 'Sports Car'],
    specs: ['630 hp · 0–60 in 2.9s · 2 Seats', '612 hp · 5 Seats · Chauffeur Available', '563 hp · 5 Seats · Chauffeur Available', '640 hp · 0–60 in 2.6s · 4 Seats'],
    pills: [['AWD', 'V10', 'Delivery'], ['Chauffeur Option', 'Delivery'], ['Chauffeur Option', 'Delivery'], ['AWD', 'Delivery']],
    ...
    reviews: [
      ...
      { q: '"Ghost was flawless for our wedding weekend. Echelon Exotics made the whole thing painless, including a driver for the reception."', name: 'Priya S.', role: 'Wedding Client' },
    ...
    footerFleetH: 'Fleet', footerFleet: ['Supercars', 'Ultra-Luxury Sedans', 'View Pricing'],
  ...
  es: {
    ...
    types: ['Superdeportivo', 'SUV Ultra de Lujo', 'Sedán Ultra de Lujo', 'Auto Deportivo'],
    specs: ['630 hp · 0–100 en 2.9s · 2 Asientos', '612 hp · 5 Asientos · Chofer Disponible', '563 hp · 5 Asientos · Chofer Disponible', '640 hp · 0–100 en 2.6s · 4 Asientos'],
    pills: [['Tracción AWD', 'V10', 'Entrega'], ['Opción de Chofer', 'Entrega'], ['Opción de Chofer', 'Entrega'], ['Tracción AWD', 'Entrega']],
    ...
    reviews: [
      ...
      { q: 'El Ghost fue impecable para el fin de semana de nuestra boda. Echelon Exotics hizo que todo fuera muy fácil, incluyendo un chofer para la recepción.', name: 'Priya S.', role: 'Cliente de Boda' },
    ...
    footerFleetH: 'Flota', footerFleet: ['Superdeportivos', 'Sedanes Ultra de Lujo', 'Ver Precios'],
  ...
  pt: {
    ...
    types: ['Superesportivo', 'SUV Ultra de Luxo', 'Sedã Ultra de Luxo', 'Carro Esportivo'],
    specs: ['630 cv · 0–100 em 2.9s · 2 Lugares', '612 cv · 5 Lugares · Motorista Disponível', '563 cv · 5 Lugares · Motorista Disponível', '640 cv · 0–100 em 2.6s · 4 Lugares'],
    pills: [['Tração AWD', 'V10', 'Entrega'], ['Opção de Motorista', 'Entrega'], ['Opção de Motorista', 'Entrega'], ['Tração AWD', 'Entrega']],
    ...
    reviews: [
      ...
      { q: 'O Ghost foi impecável para o fim de semana do nosso casamento. A Echelon Exotics tornou tudo simples, incluindo um motorista para a recepção.', name: 'Priya S.', role: 'Cliente de Casamento' },
    ...
    footerFleetH: 'Frota', footerFleet: ['Superesportivos', 'Sedãs Ultra de Luxo', 'Ver Preços'],
